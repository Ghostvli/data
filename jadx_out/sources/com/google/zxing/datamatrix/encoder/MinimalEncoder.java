        ...
        */
        public byte[] getLatchBytes() {
            ...
            L24:
                ...
                if (r0 == r11) goto L6f
                com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode r12 = r12.mode
                int r12 = r12.ordinal()
                ...
                goto L6f
            L41:
                byte[] r12 = getBytes(r0, r5)
                return r12
            L46:
                byte[] r12 = getBytes(r0, r4)
                return r12
            L4b:
                byte[] r12 = getBytes(r0, r3)
                return r12
            L50:
                byte[] r12 = getBytes(r0, r2)
                return r12
            L55:
                byte[] r12 = getBytes(r0, r1)
                return r12
            L5a:
                byte[] r12 = getBytes(r0)
                return r12
            L5f:
                com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode r12 = r12.mode
                int r12 = r12.ordinal()
            ...
            L6f:
                ...
                return r12
            L73:
                byte[] r12 = getBytes(r5)
                return r12
            L78:
                byte[] r12 = getBytes(r4)
                return r12
            L7d:
                byte[] r12 = getBytes(r3)
                return r12
            L82:
                byte[] r12 = getBytes(r2)
                return r12
            L87:
                byte[] r12 = getBytes(r1)
                return r12
            */
