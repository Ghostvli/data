...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        int i9 = 56;
        Version version13 = new Version(13, 44, 44, 20, 20, new ECBlocks(i9, new ECB(i, Token.LABEL)));
        int i10 = 68;
        Version version14 = new Version(14, 48, 48, 22, 22, new ECBlocks(i10, new ECB(i, Token.DEBUGGER)));
        int i11 = 2;
        ...
        Version version19 = new Version(19, 88, 88, 20, 20, new ECBlocks(i9, new ECB(i12, Token.LABEL)));
        Version version20 = new Version(20, 96, 96, 22, 22, new ECBlocks(i10, new ECB(i12, Token.DEBUGGER)));
        int i13 = 6;
        Version version21 = new Version(21, Token.ASSIGN_LOGICAL_AND, Token.ASSIGN_LOGICAL_AND, 24, 24, new ECBlocks(i9, new ECB(i13, Token.WITH)));
        Version version22 = new Version(22, 120, 120, 18, 18, new ECBlocks(i10, new ECB(i13, Token.COMMENT)));
        Version version23 = new Version(23, Token.FOR, Token.FOR, 20, 20, new ECBlocks(i7, new ECB(i3, Token.TO_OBJECT)));
        Version version24 = new Version(24, Token.LABEL, Token.LABEL, 22, 22, new ECBlocks(i7, new ECB(i3, Token.SET_REF_OP), new ECB(i11, Token.LOCAL_BLOCK)));
        int i14 = 1;
