...
public final class BitMatrix implements Cloneable {
    ...
    public BitMatrix(int i, int i2) {
        if (i < 1 || i2 < 1) {
            jl.a("Both dimensions must be greater than 0");
            throw null;
        }
        this.width = i;
        this.height = i2;
            ...
            if (str.charAt(length) == '\n' || str.charAt(length) == '\r') {
                ...
                if (str.startsWith(str2, length)) {
                    ...
                    if (!str.startsWith(str3, length)) {
                        jl.a("illegal character encountered: ".concat(str.substring(length)));
                        return null;
                    }
                    length += str3.length();
                    zArr[i2] = false;
    ...
    public void rotate(int i) {
        ...
        if (i2 != 0) {
            ...
            if (i2 == 180) {
                ...
                jl.a("degrees must be a multiple of 0, 90, 180, or 270");
            } else {
                rotate90();
                rotate180();
            }
    ...
    public void setRegion(int i, int i2, int i3, int i4) {
        if (i2 < 0 || i < 0) {
            jl.a("Left and top must be nonnegative");
            return;
        }
        if (i4 < 1 || i3 < 1) {
            jl.a("Height and width must be at least 1");
            return;
        }
        int i5 = i3 + i;
        int i6 = i4 + i2;
        if (i6 > this.height || i5 > this.width) {
            jl.a("The region must fit inside the matrix");
            return;
        }
        while (i2 < i6) {
    ...
    public void xor(BitMatrix bitMatrix) {
        if (this.width != bitMatrix.width || this.height != bitMatrix.height || this.rowSize != bitMatrix.rowSize) {
            jl.a("input matrix dimensions do not match");
            return;
        }
        BitArray bitArray = new BitArray(this.width);
        for (int i = 0; i < this.height; i++) {
