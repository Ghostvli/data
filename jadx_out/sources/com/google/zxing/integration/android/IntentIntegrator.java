...
public class IntentIntegrator {
    ...
    public static IntentIntegrator forSupportFragment(p51 p51Var) {
        IntentIntegrator intentIntegrator = new IntentIntegrator(p51Var.O());
        intentIntegrator.supportFragment = p51Var;
        return intentIntegrator;
    }
    ...
    public void startActivity(Intent intent) {
        ...
        p51 p51Var = this.supportFragment;
        if (p51Var != null) {
            p51Var.o2(intent);
        } else {
