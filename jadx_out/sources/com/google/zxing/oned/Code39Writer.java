...
public final class Code39Writer extends OneDimensionalCodeWriter {
    ...
    */
    ...
    public boolean[] encode(String str) {
        ...
        if (length > 80) {
            b.a("Requested contents should be less than 80 digits long, but got ", length);
            return null;
        }
        int i = 0;
        while (true) {
            ...
            if ("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str.charAt(i)) < 0) {
                ...
                length = str.length();
                if (length > 80) {
                    ug4.a("Requested contents should be less than 80 digits long, but got ", length, " (extended full ASCII mode)");
                    return null;
                }
            } else {
                i++;
        ...
        toIntArray(Token.EXPR_RESULT, iArr);
