...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    public Set<K> keySet() {
        if (this.keySet == null) {
            this.keySet = new AbstractSet<K>() { // from class: org.jupnp.support.shared.AbstractMap.1
                ...
                public Iterator<K> iterator() {
                    return new Iterator<K>() { // from class: org.jupnp.support.shared.AbstractMap.1.1
    ...
    public Collection<V> values() {
        if (this.valuesCollection == null) {
            this.valuesCollection = new AbstractCollection<V>() { // from class: org.jupnp.support.shared.AbstractMap.2
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() { // from class: org.jupnp.support.shared.AbstractMap.2.1
                        Iterator<Map.Entry<K, V>> setIterator;
