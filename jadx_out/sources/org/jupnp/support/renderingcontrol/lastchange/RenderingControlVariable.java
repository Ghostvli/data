...
public class RenderingControlVariable {
    public static final Set<Class<? extends EventedValue<?>>> ALL = new HashSet<Class<? extends EventedValue<?>>>() { // from class: org.jupnp.support.renderingcontrol.lastchange.RenderingControlVariable.1
