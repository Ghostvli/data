...
public class NativeInt32Array extends NativeTypedArrayView<Integer> {
    ...
    public static void init(Context context, Scriptable scriptable, boolean z) {
        LambdaConstructor lambdaConstructor = new LambdaConstructor(scriptable, CLASS_NAME, 3, 2, new Constructable() { // from class: ty2
            ...
            public final Scriptable construct(Context context2, Scriptable scriptable2, Object[] objArr) {
                return NativeTypedArrayView.js_constructor(context2, scriptable2, objArr, new NativeTypedArrayView.TypedArrayConstructable() { // from class: sy2
        ...
        NativeTypedArrayView.init(context, scriptable, lambdaConstructor, new NativeTypedArrayView.RealThis() { // from class: uy2
            ...
            public final NativeTypedArrayView realThis(Scriptable scriptable2) {
                return NativeInt32Array.realThis(scriptable2);
            }
        });
