...
public abstract class l93 {
    ...
    */
    public static void g(java.lang.String r8, int r9, l93.a r10) {
        /*
            r0 = 0
            r10.b = r0
            r1 = r9
        ...
        L3c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.l93.g(java.lang.String, int, l93$a):void");
    }
    ...
    public static class b {
        ...
        public b(b bVar) {
            this.a = bVar.a;
            float[] fArr = bVar.b;
            this.b = l93.c(fArr, 0, fArr.length);
        }
        ...
        public static void e(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            ...
            while (i4 < fArr2.length) {
                if (c2 == 'A') {
                    ...
                    g(path, f27, f28, f29, f30, f31, f32, f33, z3, fArr2[i3 + 4] != f ? z2 : z);
                    f19 = fArr2[i5];
                    f23 = f19;
                    f20 = fArr2[i6];
                    f24 = f20;
                    ...
                    if (c2 != 'Q') {
                        ...
                        if (c2 == 'V') {
                            ...
                            float f52 = f23;
                            g(path, f52, f6, f47, f48, f49, f50, f51, z4, z7);
                            f23 = f52 + fArr2[i28];
                            f24 = f6 + fArr2[i29];
                            f19 = f23;
                            f20 = f24;
