...
public final class uk0 implements i35 {
    public final LinearLayoutCompat a;
    public final AppCompatImageView b;
    public final CustomRecyclerView c;
    public final MaterialTextView d;

    public uk0(LinearLayoutCompat linearLayoutCompat, AppCompatImageView appCompatImageView, CustomRecyclerView customRecyclerView, MaterialTextView materialTextView) {
        ...
        if (appCompatImageView != null) {
            ...
            if (customRecyclerView != null) {
                ...
                if (materialTextView != null) {
                    return new uk0((LinearLayoutCompat) view, appCompatImageView, customRecyclerView, materialTextView);
                }
            }
        }
