...
public abstract class o31 extends ViewGroup {
    public int f;
    public int g;
    public boolean h;
    public int i;
    ...
    public final void d(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, cn3.o2, 0, 0);
        this.f = typedArrayObtainStyledAttributes.getDimensionPixelSize(cn3.q2, 0);
        this.g = typedArrayObtainStyledAttributes.getDimensionPixelSize(cn3.p2, 0);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i5 < getChildCount()) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                z2 = z3;
                if (!this.h && measuredWidth2 > i8) {
                    measuredWidth2 = paddingRight + marginStart + childAt.getMeasuredWidth();
                    i6 = paddingTop + this.f;
                    this.i++;
                    measuredWidth = paddingRight;
                }
                childAt.setTag(ol3.r, Integer.valueOf(this.i - 1));
                ...
                measuredWidth += marginStart + marginEnd + childAt.getMeasuredWidth() + this.g;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i8 = 0; i8 < getChildCount(); i8++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                paddingLeft2 = paddingLeft + i3 + i4 + childAt.getMeasuredWidth() + this.g;
