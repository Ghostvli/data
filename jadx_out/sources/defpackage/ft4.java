...
public abstract class ft4 {
    ...
    public static View a(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(iRound3 - iRound, Buffer.MAX_SIZE), View.MeasureSpec.makeMeasureSpec(iRound4 - iRound2, Buffer.MAX_SIZE));
