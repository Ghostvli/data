...
public final class e3 implements i35 {
    public final LinearLayoutCompat a;
    public final ProgressLayout b;
    public final RecyclerView c;
    public final MaterialToolbar d;

    public e3(LinearLayoutCompat linearLayoutCompat, ProgressLayout progressLayout, RecyclerView recyclerView, MaterialToolbar materialToolbar) {
        ...
        if (progressLayout != null) {
            ...
            if (recyclerView != null) {
                ...
                if (materialToolbar != null) {
                    return new e3((LinearLayoutCompat) view, progressLayout, recyclerView, materialToolbar);
                }
            }
        }
    ...
    public static e3 d(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(fm3.d, viewGroup, false);
        if (z) {
