    ...
    public void update(Activity activity, View view) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                android.view.WindowInsets insets = activity.getWindowManager().getCurrentWindowMetrics().getWindowInsets();
                ...
                rect.left = Math.max(rect.left, outRect.left);
                rect.top = Math.max(rect.top, outRect.top);
                rect.right = Math.min(rect.right, outRect.right);
                rect.bottom = Math.min(rect.bottom, outRect.bottom);
            }
    ...
    public void enter(Activity activity, int width, int height, int scale) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                ...
                builder.setSeamlessResizeEnabled(!isLandscape);
            }
