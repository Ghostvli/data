...
public class Setting {
    ...
    public static int getPlayerEngine() {
        return Prefers.getInt("player_engine", 1);
    }
    ...
    public static void putMpvDecode(int decode) {
        Prefers.put("mpv_decode", decode);
    }

    public static boolean getZteNatAuto() {
        return Prefers.getBoolean("zte_nat_auto", false);
    }

    public static void putZteNatAuto(boolean auto) {
        Prefers.put("zte_nat_auto", auto);
    }
}
