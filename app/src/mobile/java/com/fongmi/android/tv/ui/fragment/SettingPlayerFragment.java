...
public class SettingPlayerFragment extends BaseFragment implements UaCallback, BufferCallback, SpeedCallback {
    ...
    protected void initView() {
        ...
        mBinding.zteNatAutoText.setText(getSwitch(Setting.getZteNatAuto()));
        mBinding.caption.setVisibility(Setting.hasCaption() ? View.VISIBLE : View.GONE);
        mBinding.scaleText.setText((scale = ResUtil.getStringArray(R.array.select_scale))[Setting.getScale()]);
        mBinding.engine.setVisibility(com.fongmi.android.tv.player.PlayerManager.isMpvSupported() ? View.VISIBLE : View.GONE);
        mBinding.engineText.setText((engine = ResUtil.getStringArray(R.array.select_player_engine))[Setting.getPlayerEngine()]);
        mBinding.rtspText.setText((rtsp = ResUtil.getStringArray(R.array.select_rtsp_transport))[Setting.getRtspTransport()]);
    ...
    protected void initEvent() {
        ...
        mBinding.rtsp.setOnClickListener(this::onRtsp);
        mBinding.zteNatAuto.setOnClickListener(this::setZteNatAuto);
    ...
    private void setZteNatAuto(View view) {
        Setting.putZteNatAuto(!Setting.getZteNatAuto());
        mBinding.zteNatAutoText.setText(getSwitch(Setting.getZteNatAuto()));
    }

    private void onEngine(View view) {
        int index = (Setting.getPlayerEngine() + 1) % engine.length;
        mBinding.engineText.setText(engine[index]);
        Setting.putPlayerEngine(index);
    }

    private void onRtsp(View view) {
        int index = (Setting.getRtspTransport() + 1) % rtsp.length;
