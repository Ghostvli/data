...
import com.github.catvod.utils.LogExport;
...
public class SettingFragment extends BaseFragment implements ConfigCallback, SiteCallback, LiveCallback {
    ...
    protected void initEvent() {
        ...
        mBinding.exportLog.setOnClickListener(this::onExportLog);
    }
    ...
    private void onExportLog(View view) {
        java.io.File file = LogExport.export(requireActivity());
        if (file == null) {
            Notify.show(R.string.backup_fail);
            return;
        }
        ...
        intent.putExtra(Intent.EXTRA_STREAM, androidx.core.content.FileProvider.getUriForFile(requireActivity(), requireActivity().getPackageName() + ".provider", file));
        intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        startActivity(Intent.createChooser(intent, getString(R.string.setting_export_log)));
    }
