...
public class SettingActivity extends BaseActivity implements ConfigCallback, SiteCallback, LiveCallback, DohCallback {
    ...
    private void onExportLog(View view) {
        java.io.File file = LogExport.export(this);
        if (file == null) {
            Notify.show(R.string.backup_fail);
            return;
        }
        ...
        intent.putExtra(Intent.EXTRA_STREAM, androidx.core.content.FileProvider.getUriForFile(this, getPackageName() + ".provider", file));
