...
public class Context implements Closeable {
    ...
    public static void checkLanguageVersion(int i) {
        ...
        defpackage.b.a("Bad language version: ", i);
    }
    ...
    public static void checkOptimizationLevel(int i) {
        ...
        defpackage.b.a("Optimization level outside [-1..9]: ", i);
    }
        ...
        if (context2 == null) {
            if (context == null) {
                ...
                if (context.enterCount != 0) {
                    e04.a("factory.makeContext() returned Context instance already associated with some thread");
                    return null;
                }
                ...
                e04.a("can not use Context instance already associated with some thread");
                return null;
            }
    ...
    public static void exit() {
        ...
        if (context == null) {
            e04.a("Calling Context.exit without previous Context.enter");
            return;
        }
    ...
    public static Context getContext() {
        ...
        zt2.a("No Context associated with current Thread");
        return null;
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: org.mozilla.javascript.Script */
    ...
    private ScriptNode parse(String str, String str2, int i, CompilerEnvirons compilerEnvirons, ErrorReporter errorReporter, boolean z) {
        ...
        if (z && (astRoot.getFirstChild() == null || astRoot.getFirstChild().getType() != 122)) {
            defpackage.c.a("compileFunction only accepts source with single JS function: ", str);
            return null;
        }
    ...
    public Object callFunctionWithContinuations(Callable callable, Scriptable scriptable, Object[] objArr) {
        if (!(callable instanceof InterpretedFunction)) {
            jl.a("Function argument was not created by interpreted mode ");
            return null;
        }
        if (ScriptRuntime.hasTopCall(this)) {
            e04.a("Cannot have any pending top calls when executing a script with continuations");
            return null;
        }
    ...
    public Object compileImpl(Scriptable scriptable, String str, String str2, int i, Object obj, boolean z, Evaluator evaluator, ErrorReporter errorReporter, Consumer<CompilerEnvirons> consumer) {
        ...
        if (obj != null && getSecurityController() == null) {
            jl.a("securityDomain should be null if setSecurityController() was never called");
            return null;
        }
        ...
        if (evaluator == null) {
            ...
            } catch (ClassFileWriter.b unused) {
    ...
    public Object executeScriptWithContinuations(Script script, Scriptable scriptable) {
        ...
        jl.a("Script argument was not a script or was not created by interpreted mode ");
        return null;
    }
    ...
    public final void setMaximumInterpreterStackDepth(int i) {
        ...
        if (!this.interpretedMode) {
            e04.a("Cannot set maximumInterpreterStackDepth outside interpreted mode");
        } else if (i >= 1) {
            this.maximumInterpreterStackDepth = i;
        } else {
            jl.a("Cannot set maximumInterpreterStackDepth to less than 1");
        }
    }
    ...
    public static Object call(ContextFactory contextFactory, final Callable callable, final Scriptable scriptable, final Scriptable scriptable2, final Object[] objArr) {
        ...
        return call(contextFactory, new ContextAction() { // from class: a30
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
