...
public class Node implements Iterable<Node> {
    ...
    public class NodeIterator implements Iterator<Node> {
        ...
        public void remove() {
            if (this.prev == Node.NOT_SET) {
                e04.a("next() has not been called");
                return;
            }
            if (this.removed) {
                e04.a("remove() already called for current element");
                return;
            }
            Node node = this.prev;
    ...
    public void addChildAfter(Node node, Node node2) {
        if (node.next != null) {
            zt2.a("newChild had siblings in addChildAfter");
            return;
        }
    ...
    public void addChildBefore(Node node, Node node2) {
        if (node.next != null) {
            zt2.a("newChild had siblings in addChildBefore");
            return;
        }
        Node node3 = this.first;
        if (node3 != node2) {
    ...
    */
    public boolean hasSideEffects() {
        ...
        L42:
            ...
            if (r0 != 0) goto L54
            org.mozilla.javascript.Node r3 = r3.last
            boolean r3 = r3.hasSideEffects()
            if (r3 == 0) goto L53
            goto L54
        L53:
            return r1
        ...
        L64:
            ...
            boolean r0 = r0.hasSideEffects()
            if (r0 == 0) goto L7b
            org.mozilla.javascript.Node r3 = r3.first
            org.mozilla.javascript.Node r3 = r3.next
            org.mozilla.javascript.Node r3 = r3.next
            boolean r3 = r3.hasSideEffects()
            if (r3 == 0) goto L7b
            return r2
