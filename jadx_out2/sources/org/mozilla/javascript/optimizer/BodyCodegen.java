...
class BodyCodegen {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Move duplicate insns, count: 1 to block B:11:0x0041 */
    ...
    */
        ...
        if (type != 179) {
            ...
            switch (type) {
                ...
                case 13:
                    int iQ = this.cfw.q();
                    int iQ2 = this.cfw.q();
                    visitIfJumpEqOp(node, firstChild, iQ, iQ2);
                    addJumpedBooleanWrap(iQ, iQ2);
                    return;
                case 14:
                case 15:
                case 16:
                case 17:
                    int iQ3 = this.cfw.q();
                    int iQ4 = this.cfw.q();
                    visitIfJumpRelOp(node, firstChild, iQ3, iQ4);
                    addJumpedBooleanWrap(iQ3, iQ4);
                    return;
                case 21:
                    generateExpression(firstChild, node);
                ...
                case 26:
                    ...
                    int iQ6 = this.cfw.q();
                    int iQ7 = this.cfw.q();
                    generateIfJump(firstChild, node, iQ5, iQ6);
                    this.cfw.r0(iQ5);
                    this.cfw.u(Token.ARROW, "java/lang/Boolean", "FALSE", "Ljava/lang/Boolean;");
                    this.cfw.s(Token.LET, iQ7);
                    this.cfw.r0(iQ6);
                    this.cfw.u(Token.ARROW, "java/lang/Boolean", "TRUE", "Ljava/lang/Boolean;");
                    this.cfw.r0(iQ7);
                    this.cfw.a0(-1);
                ...
                case 30:
                    ...
                    if (intProp5 != 0) {
                        visitSpecialCall(node, type, intProp5, firstChild);
                        return;
                    }
                ...
                case Token.HOOK /* 115 */:
                    ...
                    int iQ10 = this.cfw.q();
                    this.cfw.s(Token.SETPROP_OP, iQ10);
                    int iO0 = this.cfw.o0();
                    generateExpression(next2, node);
                    int iQ11 = this.cfw.q();
                    this.cfw.s(Token.LET, iQ11);
                    this.cfw.s0(iQ10, iO0);
                ...
                case Token.NULLISH_COALESCING /* 185 */:
                    ...
                    this.cfw.r(89);
                    addOptRuntimeInvoke("isNullOrUndefined", Signatures.MATH_TO_BOOLEAN);
                    this.cfw.s(Token.SETPROP_OP, iQ12);
                    this.cfw.r(87);
                    generateExpression(firstChild.getNext(), node);
                    this.cfw.r0(iQ12);
                    return;
                default:
                    switch (type) {
                        ...
                        case Token.REGEXP /* 53 */:
                            ...
                            classFileWriter3.u(Token.ARROW, codegen.mainClassName, codegen.getCompiledRegexpName(this.scriptOrFn, existingIntProp), "Ljava/lang/Object;");
                            this.cfw.F(Token.DOTDOTDOT, "org/mozilla/javascript/ScriptRuntime", "wrapRegExp", "(Lorg/mozilla/javascript/Context;Lorg/mozilla/javascript/Scriptable;Ljava/lang/Object;)Lorg/mozilla/javascript/Scriptable;");
                            return;
                                        ...
                                        default:
                                            switch (type) {
                                                ...
                                                case Token.GET_REF /* 73 */:
                                                    ...
                                                    this.cfw.r(89);
                                                    addOptRuntimeInvoke("isNullOrUndefined", Signatures.MATH_TO_BOOLEAN);
                                                    this.cfw.s(Token.SETPROP_OP, iQ13);
                                                    this.cfw.s(Token.LET, iQ14);
                                                    this.cfw.r0(iQ13);
                                                    this.cfw.t(192, "org/mozilla/javascript/Ref");
                                                    finishGetRefGeneration();
                                                    this.cfw.r0(iQ14);
                                                    return;
                                                ...
                                                case Token.REF_SPECIAL /* 77 */:
                                                    ...
                                                    this.cfw.r(89);
                                                    addOptRuntimeInvoke("isNullOrUndefined", Signatures.MATH_TO_BOOLEAN);
                                                    this.cfw.s(Token.SETPROP_OP, iQ15);
                                                    this.cfw.r(87);
                                                    this.cfw.u(Token.ARROW, "org/mozilla/javascript/Undefined", "instance", "Ljava/lang/Object;");
                                                    this.cfw.s(Token.LET, iQ16);
                                                    this.cfw.r0(iQ15);
                                                    finishRefSpecialGeneration(node);
                                                    this.cfw.r0(iQ16);
                                                    return;
                                                ...
                                                case Token.SUPER /* 79 */:
                                                    ...
                                                    this.cfw.r(87);
                                                    this.cfw.u(Token.ARROW, "org/mozilla/javascript/Undefined", "instance", "Ljava/lang/Object;");
                                                    this.cfw.s(Token.LET, iQ17);
                                                    this.cfw.r0(iQ18);
                                                    this.cfw.F(Token.NULLISH_COALESCING, "org/mozilla/javascript/Scriptable", "getPrototype", "()Lorg/mozilla/javascript/Scriptable;");
                                                    this.cfw.r0(iQ17);
                                                    return;
                                                ...
                                                case 89:
                                                    ...
                                                    this.cfw.t(Token.LAST_TOKEN, "java/math/BigInteger");
                                                    int i4 = 89;
                                                    this.cfw.r(89);
                                                    this.cfw.Q(byteArray.length);
                                                    this.cfw.s(188, 8);
                                                    while (true) {
                                                        int length = byteArray.length;
                                                        ClassFileWriter classFileWriter4 = this.cfw;
                                                        if (i3 >= length) {
                                                            classFileWriter4.F(Token.TAGGED_TEMPLATE_LITERAL, "java/math/BigInteger", "<init>", "([B)V");
                                                            return;
                                                        }
                                                        classFileWriter4.r(i4);
                                                        this.cfw.Q(i3);
                                                        this.cfw.s(16, byteArray[i3]);
                                                        this.cfw.r(84);
                                                        i3++;
                                                        i4 = 89;
                                                    }
                                                ...
                                                default:
                                                    switch (type) {
                                                        ...
                                                        case Token.AND /* 118 */:
                                                            ...
                                                            if (type == 118) {
                                                                classFileWriter5.s(Token.SETPROP_OP, iQ19);
                                                            } else {
                                                                classFileWriter5.s(Token.SETELEM_OP, iQ19);
                                                            }
                                                            this.cfw.r(87);
                                                            generateExpression(firstChild.getNext(), node);
                                                            this.cfw.r0(iQ19);
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Move duplicate insns, count: 1 to block B:23:0x0092 */
        ...
        if (type == 12 || type == 13 || !(node3.getType() == 47 || next.getType() == 47)) {
            ...
            if (iNodeIsDirectCallParameter == -1 || next.getType() != 163) {
                ...
                if (firstChild.getType() == 45) {
                    ...
                    this.cfw.P(firstChild.getDouble());
                    this.cfw.r(Token.TYPEOFNAME);
                    ClassFileWriter classFileWriter = this.cfw;
                    if (type == 12) {
                        i3 = Token.SETPROP_OP;
                        classFileWriter.s(Token.SETPROP_OP, i);
                        i4 = Token.SETELEM_OP;
                    } else {
                        i3 = Token.SETPROP_OP;
                        i4 = Token.SETELEM_OP;
                        classFileWriter.s(Token.SETELEM_OP, i);
                    }
                    this.cfw.s(Token.LET, i2);
                    this.cfw.r0(iQ);
                }
