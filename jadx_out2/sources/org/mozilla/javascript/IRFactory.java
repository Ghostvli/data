...
public final class IRFactory {
            ...
            if (type2 == 135 || type2 == 167) {
                ...
                if (type != 71 && type != 72) {
                    if (type == 44) {
                        ...
                        type2 = -1;
                        node5 = new Node(Token.LOCAL_BLOCK);
                        Node node6 = new Node(!z ? 64 : z2 ? 66 : type2 != -1 ? 65 : 63, node3);
                        node6.putProp(3, node5);
                        Node node7 = new Node(67);
                        node7.putProp(3, node5);
                        Node node8 = new Node(68);
                        node8.putProp(3, node5);
                        Node node9 = new Node(Token.BLOCK);
                        Parser parser = this.parser;
                        if (type2 == -1) {
                            nodeSimpleAssignment = parser.createDestructuringAssignment(i, nodeNewString, node8, new c(this));
                            if (!z && !z2 && (type2 == 72 || destructuringLength != 2)) {
                                this.parser.reportError("msg.bad.for.in.destruct");
                            }
                        } else {
                            nodeSimpleAssignment = parser.simpleAssignment(nodeNewString, node8);
                        }
                        node9.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                        node9.addChildToBack(node4);
                        nodeCreateLoop = createLoop((Jump) node, 1, node9, node7, null, null);
                ...
                type2 = type;
                node5 = new Node(Token.LOCAL_BLOCK);
                Node node62 = new Node(!z ? 64 : z2 ? 66 : type2 != -1 ? 65 : 63, node3);
                node62.putProp(3, node5);
                Node node72 = new Node(67);
                node72.putProp(3, node5);
                Node node82 = new Node(68);
                node82.putProp(3, node5);
                Node node92 = new Node(Token.BLOCK);
                Parser parser2 = this.parser;
                if (type2 == -1) {
                }
                node92.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                node92.addChildToBack(node4);
                nodeCreateLoop = createLoop((Jump) node, 1, node92, node72, null, null);
                nodeCreateLoop.addChildToFront(node62);
                if (type != 135) {
                    nodeCreateLoop.addChildToFront(node2);
                    node5.addChildToBack(nodeCreateLoop);
                }
            } else if (type2 == 71 || type2 == 72) {
                destructuringLength = node2 instanceof ArrayLiteral ? ((ArrayLiteral) node2).getDestructuringLength() : 0;
                nodeNewString = node2;
                type = type2;
                node5 = new Node(Token.LOCAL_BLOCK);
                Node node622 = new Node(!z ? 64 : z2 ? 66 : type2 != -1 ? 65 : 63, node3);
                node622.putProp(3, node5);
                Node node722 = new Node(67);
                node722.putProp(3, node5);
                Node node822 = new Node(68);
                node822.putProp(3, node5);
                Node node922 = new Node(Token.BLOCK);
                Parser parser22 = this.parser;
                if (type2 == -1) {
                }
                node922.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                node922.addChildToBack(node4);
                nodeCreateLoop = createLoop((Jump) node, 1, node922, node722, null, null);
                nodeCreateLoop.addChildToFront(node622);
                if (type != 135) {
                }
            } else {
                ...
                if (nodeNewString == null) {
                    ...
                    type2 = -1;
                    node5 = new Node(Token.LOCAL_BLOCK);
                    Node node6222 = new Node(!z ? 64 : z2 ? 66 : type2 != -1 ? 65 : 63, node3);
                    node6222.putProp(3, node5);
                    Node node7222 = new Node(67);
                    node7222.putProp(3, node5);
                    Node node8222 = new Node(68);
                    node8222.putProp(3, node5);
                    Node node9222 = new Node(Token.BLOCK);
                    Parser parser222 = this.parser;
                    if (type2 == -1) {
                    }
                    node9222.addChildToBack(new Node(Token.EXPR_VOID, nodeSimpleAssignment));
                    node9222.addChildToBack(node4);
                    nodeCreateLoop = createLoop((Jump) node, 1, node9222, node7222, null, null);
                    nodeCreateLoop.addChildToFront(node6222);
                    if (type != 135) {
                    }
                }
            }
                                    ...
                                    default:
                                        switch (type) {
                                            ...
                                            default:
                                                ...
                                                jl.a("Can't transform: ".concat(String.valueOf(astNode)));
                                                return null;
                                        }
                                        break;
                                }
    ...
    */
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: org.mozilla.javascript.Node */
