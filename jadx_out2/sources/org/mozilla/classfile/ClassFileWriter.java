...
public class ClassFileWriter {
    ...
    public final class d {
        ...
        */
        public final int e(int i) {
            ...
            int iX;
            int iH;
            int i2 = ClassFileWriter.this.i[i] & 255;
            switch (i2) {
                case 0:
                case Token.FOR /* 132 */:
                case Token.LET /* 167 */:
                case 200:
                    iX0 = 0;
                    if (iX0 == 0) {
                        iX0 = ClassFileWriter.x0(i2, this.j);
                    }
                    if (this.j && i2 != 196) {
                        this.j = false;
                    }
                ...
                case 19:
                case 20:
                    byte bQ = ClassFileWriter.this.k.q(i2 == 18 ? o(i + 1) : p(i + 1, 2));
                    if (bQ == 3) {
                        z(1);
                    } else if (bQ == 4) {
                        z(2);
                        ...
                        defpackage.b.a("bad const type ", bQ);
                    } else {
                        z(uu4.b("java/lang/String", ClassFileWriter.this.k));
                    }
                    iX0 = 0;
                    if (iX0 == 0) {
                    }
                ...
                case 50:
                    x();
                    String str = (String) ClassFileWriter.this.k.p(x() >>> 8);
                    if (str.charAt(0) != '[') {
                        e04.a("bad array type");
                        break;
                    } else {
                        z(uu4.a(ClassFileWriter.this.k.a(ClassFileWriter.g0(str.substring(1)))));
                        iX0 = 0;
                        if (iX0 == 0) {
                        }
                        if (this.j) {
                ...
                case 197:
                default:
                    defpackage.b.a("bad opcode: ", i2);
                    break;
                case 170:
                    int i3 = i + 1 + ((~i) & 3);
                    iX0 = ((((p(i3 + 8, 4) - p(i3 + 4, 4)) + 4) * 4) + i3) - i;
                    x();
                    if (iX0 == 0) {
                    }
                    if (this.j) {
                ...
                case Token.ARROW /* 178 */:
                    z(uu4.d(ClassFileWriter.g0(((a01) ClassFileWriter.this.k.p(p(i + 1, 2))).c()), ClassFileWriter.this.k));
                    iX0 = 0;
                    if (iX0 == 0) {
                    }
                    if (this.j) {
                ...
                case Token.NULLISH_COALESCING /* 185 */:
                    a01 a01Var = (a01) ClassFileWriter.this.k.p(p(i + 1, 2));
                    String strC = a01Var.c();
                    String strB = a01Var.b();
                    int iE0 = ClassFileWriter.E0(strC) >>> 16;
                    for (int i4 = 0; i4 < iE0; i4++) {
                        x();
                    }
                    if (i2 != 184 && ((iH = uu4.h((iX = x()))) == uu4.c(0) || iH == 6)) {
                        if (!"<init>".equals(strB)) {
                            e04.a("bad instance");
                        } else {
                            s(iX, iH == uu4.c(0) ? uu4.b(a01Var.a(), ClassFileWriter.this.k) : uu4.a(ClassFileWriter.this.t));
                        }
                    }
                    String strG0 = ClassFileWriter.g0(strC.substring(strC.indexOf(41) + 1));
                    if (!strG0.equals("V")) {
                        z(uu4.d(strG0, ClassFileWriter.this.k));
                    }
                    iX0 = 0;
                    if (iX0 == 0) {
                    }
                ...
                case Token.QUESTION_DOT /* 186 */:
                    String str2 = (String) ClassFileWriter.this.k.p(p(i + 1, 2));
                    int iE02 = ClassFileWriter.E0(str2) >>> 16;
                    for (int i5 = 0; i5 < iE02; i5++) {
                        x();
                    }
                    String strG02 = ClassFileWriter.g0(str2.substring(str2.indexOf(41) + 1));
                    if (!strG02.equals("V")) {
                        z(uu4.d(strG02, ClassFileWriter.this.k));
                    }
                    iX0 = 0;
                    if (iX0 == 0) {
                    }
                ...
                case 188:
                    x();
                    char cB0 = ClassFileWriter.b0(ClassFileWriter.this.i[i + 1]);
                    org.mozilla.classfile.a aVar = ClassFileWriter.this.k;
                    z(uu4.a(aVar.a("[" + cB0)));
                    iX0 = 0;
                    if (iX0 == 0) {
                    }
                    ...
                    break;
                case 189:
                    String str3 = (String) ClassFileWriter.this.k.p(p(i + 1, 2));
                    x();
                    z(uu4.b("[L" + str3 + ";", ClassFileWriter.this.k));
                    iX0 = 0;
                    if (iX0 == 0) {
                    }
                    if (this.j) {
    ...
    static {
        ...
        try {
            try {
                InputStream inputStreamB0 = B0();
                try {
                    try {
                        if (inputStreamB0 != null) {
                            byte[] bArr = new byte[8];
                            int i3 = 0;
                            while (i3 < 8) {
                                int i4 = inputStreamB0.read(bArr, i3, 8 - i3);
                                if (i4 < 0) {
    ...
    */
    public static int E0(String str) {
        ...
        if (3 <= length && str.charAt(0) == '(') {
            boolean z3 = true;
            if (1 <= iLastIndexOf && (i = iLastIndexOf + 1) < length) {
                int i2 = 1;
                int i3 = 0;
                int i4 = 0;
                while (i2 != iLastIndexOf) {
                    ...
                    if (cCharAt != 'F') {
                                    ...
                                    if (cCharAt != 'Z') {
                                        if (cCharAt != '[') {
                                            ...
                                            if (z) {
                                                ...
                                                if (cCharAt2 == 'F' || cCharAt2 == 'L' || cCharAt2 == 'S') {
                                                    i3++;
                                                    if (z) {
                                            ...
                                            if (cCharAt3 != 'F') {
                                                if (cCharAt3 != 'L') {
                                                    if (cCharAt3 != 'S' && cCharAt3 != 'Z' && cCharAt3 != 'I' && cCharAt3 != 'J') {
                                                        switch (cCharAt3) {
                                                        }
                                                    }
                                                }
                        ...
                        i4++;
                        z2 = z3;
                        int iIndexOf = str.indexOf(59, i2 + 1);
                        if (i2 + 2 > iIndexOf || iIndexOf >= iLastIndexOf) {
                            z = false;
                            if (z) {
                            }
                        } else {
        ...
        jl.a("Bad parameter signature: ".concat(str));
        return 0;
    }
    ...
    */
    public final int[] f0() {
        ...
        if (iIndexOf != 0 || iIndexOf2 < 0) {
            jl.a("bad method type");
            return null;
        }
        int i2 = iIndexOf + 1;
        StringBuilder sb = new StringBuilder();
        while (i2 < iIndexOf2) {
            char cCharAt = strC.charAt(i2);
            if (cCharAt != 'F') {
                if (cCharAt == 'L') {
                    int iIndexOf3 = strC.indexOf(59, i2) + 1;
                    sb.append(strC.substring(i2, iIndexOf3));
                    i2 = iIndexOf3;
                ...
                int iD = uu4.d(g0(sb.toString()), this.k);
                int i3 = i + 1;
                iArr[i] = iD;
                i = !uu4.i(iD) ? i + 2 : i3;
                sb.setLength(0);
            }
            sb.append(strC.charAt(i2));
            i2++;
            int iD2 = uu4.d(g0(sb.toString()), this.k);
            int i32 = i + 1;
            iArr[i] = iD2;
            if (!uu4.i(iD2)) {
            }
            ...
            if (i != 198 && i != 199) {
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case Token.SETCONST /* 169 */:
                                        break;
                                    default:
                                        jl.a("Unexpected opcode for 1 operand");
                                        return;
                                }
                            case Token.BINDNAME /* 54 */:
                            case Token.THROW /* 55 */:
                ...
                if (i3 != Integer.MIN_VALUE) {
                    ...
                    if (iM0 != -1) {
                        Y(iM0 - i4);
                        V(iM0);
                        this.c.put(Integer.valueOf(iM0), Integer.valueOf(i4));
                    } else {
                        I(i2, i4 + 1);
                        Y(0);
                    }
