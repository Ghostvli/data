...
public final class o extends a implements Serializable {
    ...
    public final j$.time.temporal.s F(j$.time.temporal.a aVar) {
        ...
        switch (n.a[aVar.ordinal()]) {
            ...
            case 4:
            case 5:
                return j$.time.temporal.s.f(k0(0), k0(this.d.length - 1) - 1);
            case 6:
    ...
    public final m I(int i) {
        ...
        j$.nio.file.j.h("invalid Hijrah era");
        return null;
    }
    ...
    public final b O(TemporalAccessor temporalAccessor) {
        return temporalAccessor instanceof q ? (q) temporalAccessor : new q(this, temporalAccessor.i(j$.time.temporal.a.EPOCH_DAY));
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Override // j$.time.chrono.l
    public final b U() {
        return new q(this, LocalDate.l0(j$.desugar.sun.nio.fs.g.z()).i(j$.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final boolean g0(long j) {
        i0();
        return j >= ((long) k0(0)) && j <= ((long) (k0(this.d.length - 1) - 1)) && o0((int) j, 12) > 354;
    }
    ...
    public final void i0() {
        ...
        try {
            ...
            int[][] iArrN0 = n0();
            int iS = (int) LocalDate.m0(1882, 11, 12).S();
            for (int i = 1300; i <= 1600; i++) {
                int[] iArr = iArrN0[i - 1300];
                if (iArr.length != 12) {
            ...
            for (int i2 = 1300; i2 < 1600; i2++) {
                int iO0 = o0(i2, 12);
                this.j = Math.min(this.j, iO0);
                this.k = Math.max(this.k, iO0);
            }
            this.c = true;
        } catch (Exception e) {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public final int[] j0(int i, Map map) {
        ...
        for (int i3 = 1300; i3 <= 1600; i3++) {
            ...
            while (i4 < 12) {
                ...
                iArr[i2] = i;
                if (i5 < 29 || i5 > 32) {
                    j$.nio.file.j.a("Invalid month length in year: 1300");
                    return null;
                }
                i += i5;
    ...
    public final long l0(int i, int i2, int i3) {
        i0();
        if (i2 < 1 || i2 > 12) {
            j$.nio.file.j.b("Invalid Hijrah month: ", i2);
            return 0L;
        }
        ...
        if (i3 < 1 || i3 > m0(i, i2)) {
            j$.nio.file.j.b("Invalid Hijrah day of month: ", i3);
            return 0L;
        }
    ...
    public final b z(int i, int i2) {
        ...
        j$.nio.file.j.b("Invalid dayOfYear: ", i2);
        return null;
    }
}
