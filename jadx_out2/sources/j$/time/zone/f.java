    ...
    public final Object e(LocalDateTime localDateTime) {
        ...
        if (this.g != null) {
            ...
            if (bVarArrB.length == 0) {
                return i(this.g.getOffset(localDateTime.B(this.b[0]) * 1000));
            }
        ...
        if (this.f.length > 0) {
            ...
            if (localDateTime2 != null) {
                ...
                z = localDateTime.u(localDateTime2) > 0;
            } else {
                long jS = localDateTime.a.S();
                long jS2 = localDateTime2.a.S();
                if (jS > jS2 || (jS == jS2 && localDateTime.b.o0() > localDateTime2.b.o0())) {
                }
            }
            if (z) {
