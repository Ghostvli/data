...
public class URLEncoder {
    public static final BitSet a = new BitSet(Buffer.DEFAULT_SIZE);
    ...
    static {
        ...
        bitSet.set(46);
        bitSet.set(42);
        b = System.getSecurityManager() == null ? System.getProperty("file.encoding") : (String) AccessController.doPrivileged(new a());
    }
