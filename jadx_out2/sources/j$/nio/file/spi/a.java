...
public final /* synthetic */ class a extends c {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [j$.adapter.b.<clinit>():void, j$.nio.file.f.h():j$.nio.file.spi.c] */
    ...
    /* JADX DEBUG: Class process forced to load method for inline: j$.nio.file.attribute.e.a(java.nio.file.attribute.BasicFileAttributes):j$.nio.file.attribute.BasicFileAttributes */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    @Override // j$.nio.file.spi.c
