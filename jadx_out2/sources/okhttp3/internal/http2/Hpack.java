...
public final class Hpack {
    ...
    public final ByteString checkLowercase(ByteString byteString) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (65 <= b && b < 91) {
                ze5.a("PROTOCOL_ERROR response malformed: mixed case name: ", byteString.utf8());
                return null;
            }
        }
        return byteString;
    ...
    public static final class Writer {
        ...
        private final void clearDynamicTable() {
            ta.r(this.dynamicTable, null, 0, 0, 6, null);
        ...
        */
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (num != null) {
                    ...
                    if (2 > length2 || length2 >= 8) {
                        length = length2;
                        length2 = -1;
                    } else if (il1.a(hpack.getSTATIC_HEADER_TABLE()[iIntValue].value, byteString)) {
                        length = length2;
                    } else if (il1.a(hpack.getSTATIC_HEADER_TABLE()[length2].value, byteString)) {
                        length = length2;
                        length2 = iIntValue + 2;
                    }
                } else {
                ...
                if (length2 == -1) {
                    ...
                    while (true) {
                        ...
                        header2.getClass();
                        if (il1.a(header2.name, asciiLowercase)) {
                            Header header3 = this.dynamicTable[i3];
                            header3.getClass();
                            if (il1.a(header3.value, byteString)) {
                ...
                } else if (!asciiLowercase.startsWith(Header.PSEUDO_PREFIX) || il1.a(Header.TARGET_AUTHORITY, asciiLowercase)) {
        ...
        public /* synthetic */ Writer(int i, boolean z, Buffer buffer, int i2, we0 we0Var) {
    ...
    public static final class Reader {
        ...
        private final ByteString getName(int i) throws IOException {
            ...
            uf1.a("Header index too large ", i + 1);
            return null;
        }
        ...
        public final List<Header> getAndResetHeaderList() {
            List<Header> listA0 = ww.a0(this.headerList);
            ...
            while (!this.source.exhausted()) {
                ...
                if ((iAnd & 128) == 128) {
                    ...
                    if (i < 0 || i > this.headerTableSizeSetting) {
                        uf1.a("Invalid dynamic table size update ", this.maxDynamicTableByteCount);
                        return;
                    }
                    adjustDynamicTableByteCount();
        ...
        public /* synthetic */ Reader(Source source, int i, int i2, int i3, we0 we0Var) {
