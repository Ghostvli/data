...
public final class CipherSuite {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i = 4; i < iMin; i++) {
                    ...
                    if (cCharAt != cCharAt2) {
                        return il1.b(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String str) {
            return sg4.K(str, "TLS_", false, 2, null) ? "SSL_".concat(str.substring(4)) : sg4.K(str, "SSL_", false, 2, null) ? "TLS_".concat(str.substring(4)) : str;
        }
    ...
    public /* synthetic */ CipherSuite(String str, we0 we0Var) {
        this(str);
    }
}
