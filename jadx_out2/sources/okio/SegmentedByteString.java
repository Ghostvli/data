...
public final class SegmentedByteString {
    ...
    public static final String toHexString(int i) {
        ...
        return sg4.v(cArr, i2, 8);
    }

    public static final String toHexString(byte b) {
        return sg4.u(new char[]{okio.internal.ByteString.getHEX_DIGIT_CHARS()[(b >> 4) & 15], okio.internal.ByteString.getHEX_DIGIT_CHARS()[b & 15]});
    }
}
