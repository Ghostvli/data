...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
        ...
        loop0: while (true) {
            ...
            while (i2 < i3) {
                ...
                if (b < 48 || b > 57) {
                    ...
                    int i4 = 48 - b;
                    j = j2;
                    if (j3 < okio.internal.Buffer.OVERFLOW_ZONE || (j3 == okio.internal.Buffer.OVERFLOW_ZONE && i4 < j4)) {
                        break loop0;
                    }
                    j3 = (j3 * 10) + ((long) i4);
                }
    ...
    */
        ...
        do {
            ...
            while (i3 < i4) {
                ...
                if (((-1152921504606846976L) & j) != 0) {
                    kl.a("Number too large: ", new Buffer().writeHexadecimalUnsignedLong(j).writeByte((int) b).readUtf8());
                    return 0L;
                }
                j = (j << 4) | ((long) i);
                i3++;
    ...
    /* JADX DEBUG: Class process forced to load method for inline: okio.internal.-Buffer.commonIndexOf$default(okio.Buffer, okio.ByteString, long, long, int, int, int, java.lang.Object):long */
    @Override // okio.BufferedSource
