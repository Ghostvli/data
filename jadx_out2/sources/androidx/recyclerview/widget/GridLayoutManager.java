...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    */
    public View h1(View view, int i, RecyclerView.x xVar, RecyclerView.c0 c0Var) {
        ...
        int i6 = cVar.j;
        int i7 = cVar.k + i6;
        if (super.h1(view, i, xVar, c0Var) == null) {
            return null;
        }
        if ((q2(i) == 1) != this.x) {
            iK02 = k0() - 1;
        ...
        boolean z = this.s == 1 && L2();
        int iF3 = F3(xVar2, c0Var2, iK02);
        int i8 = -1;
        int i9 = -1;
        int iMin = 0;
        int iMin2 = 0;
        ...
        View view6 = null;
        while (i10 != iK0) {
            int iF32 = F3(xVar2, c0Var2, i10);
            View viewJ0 = j0(i10);
            if (viewJ0 == viewC0) {
                break;
            }
            if (!viewJ0.hasFocusable() || iF32 == iF3) {
                c cVar2 = (c) viewJ0.getLayoutParams();
                int i11 = cVar2.j;
                view2 = viewC0;
                int i12 = cVar2.k + i11;
                if (viewJ0.hasFocusable() && i11 == i6 && i12 == i7) {
                    return viewJ0;
                }
                if (!(viewJ0.hasFocusable() && view5 == null) && (viewJ0.hasFocusable() || view6 != null)) {
                    view3 = view5;
                    int iMin3 = Math.min(i12, i7) - Math.max(i11, i6);
                    if (!viewJ0.hasFocusable()) {
                        if (view3 == null) {
                            view4 = view6;
                            i3 = iMin;
                            if (W0(viewJ0, false, true)) {
                                i4 = iMin2;
                                if (iMin3 > i4) {
                                    i5 = i9;
                                } else if (iMin3 == i4) {
                                ...
                                zHasFocusable = viewJ0.hasFocusable();
                                int i13 = cVar2.j;
                                if (zHasFocusable) {
