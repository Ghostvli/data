...
public class StaggeredGridLayoutManager extends RecyclerView.q implements RecyclerView.b0.b {
    ...
    */
    public View Q2() {
        ...
        byte b2 = (this.w == 1 && S2()) ? (byte) 1 : (byte) -1;
        if (this.A) {
            iK0 = -1;
        } else {
            i2 = 0;
        ...
        while (i2 != iK0) {
            ...
            if (!bitSet.get(cVar.j.e)) {
                if (!cVar.k && (i = i2 + i3) != iK0) {
                    View viewJ02 = j0(i);
                    z = this.A;
                    m mVar = this.u;
                    if (z) {
                        int iG = mVar.g(viewJ0);
                        int iG2 = this.u.g(viewJ02);
                        if (iG <= iG2) {
                            if (iG != iG2) {
                                continue;
                            }
                        ...
                        int iD = mVar.d(viewJ0);
                        int iD2 = this.u.d(viewJ02);
                        if (iD >= iD2) {
                            if (iD == iD2) {
                                if ((cVar.j.e - ((c) viewJ02.getLayoutParams()).j.e < 0) != (b2 < 0)) {
                                }
                            } else {
                                continue;
                            }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final void V2(RecyclerView.x xVar, RecyclerView.c0 c0Var, boolean z) {
        e eVar;
        b bVar = this.L;
        ...
        if (this.I == null && this.C == -1 && (bVar.c != this.G || S2() != this.H)) {
            this.E.b();
            bVar.d = true;
        }
        if (k0() > 0 && ((eVar = this.I) == null || eVar.h < 1)) {
            if (bVar.d) {
        ...
        if (bVar.c) {
            f3(-1);
            A2(xVar, this.y, c0Var);
            f3(1);
            j jVar = this.y;
            jVar.c = bVar.a + jVar.d;
            A2(xVar, jVar, c0Var);
        } else {
            f3(1);
            A2(xVar, this.y, c0Var);
        ...
        if (!z || c0Var.e() || this.F == 0 || k0() <= 0 || (!this.M && Q2() == null)) {
            z2 = false;
        } else {
            N1(this.P);
            if (!r2()) {
