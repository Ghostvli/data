...
public class ActionMenuView extends LinearLayoutCompat implements e.b, j {
    ...
    */
    public static int H(View view, int i, int i2, int i3, int i4) {
        ...
        cVar.d = z;
        cVar.b = i5;
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, Buffer.MAX_SIZE), iMakeMeasureSpec);
        return i5;
    }
    ...
    /* JADX DEBUG: Method merged with bridge method: k(Landroid/view/ViewGroup$LayoutParams;)Landroidx/appcompat/widget/LinearLayoutCompat$a; */
    ...
    /* JADX DEBUG: Method merged with bridge method: i()Landroidx/appcompat/widget/LinearLayoutCompat$a; */
    @Override // androidx.appcompat.widget.LinearLayoutCompat
    ...
    /* JADX DEBUG: Method merged with bridge method: j(Landroid/util/AttributeSet;)Landroidx/appcompat/widget/LinearLayoutCompat$a; */
    @Override // androidx.appcompat.widget.LinearLayoutCompat
