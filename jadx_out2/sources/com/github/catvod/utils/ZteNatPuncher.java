...
public class ZteNatPuncher {
    ...
    public class Session {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:212:0x0141 */
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:77:0x0180 */
        ...
        */
        private String forwardToUpstream(String str, String str2) {
            ...
            try {
                ...
                boolean zEquals = "SETUP".equals(str5);
                String str7 = ServiceReference.DELIMITER;
                if (zEquals) {
                    strRewriteUriForUpstream = this.contentBase;
                    if (strRewriteUriForUpstream == null) {
                        strRewriteUriForUpstream = rewriteUriForUpstream(str6);
                    }
                    String str8 = this.trackId;
                    if (str8 != null && !str8.equals("*")) {
                        if (!strRewriteUriForUpstream.endsWith(ServiceReference.DELIMITER)) {
                            strRewriteUriForUpstream = strRewriteUriForUpstream.concat(ServiceReference.DELIMITER);
                        }
                    ...
                    try {
                        ...
                        try {
                            if (upstreamResponse == null) {
                                ...
                                return buildRtspResponse(Equals, "Upstream timeout");
                            }
            ...
            Log.e(ZteNatPuncher.TAG, "forwardToUpstream error", e);
            return buildRtspResponse(r4, "Proxy error: " + e.getMessage());
        }
