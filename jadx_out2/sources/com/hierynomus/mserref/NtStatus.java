...
public enum NtStatus implements EnumWithValue<NtStatus> {
    ...
    STATUS_FILE_LOCK_CONFLICT(3221225556L),
    STATUS_LOCK_NOT_GRANTED(3221225557L),
    ...
    STATUS_RANGE_NOT_LOCKED(3221225598L),
    ...
    STATUS_INSUFF_SERVER_RESOURCES(3221225989L),
    ...
    STATUS_IO_REPARSE_TAG_NOT_HANDLED(3221226105L),
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static NtStatus valueOf(long j) {
        return (NtStatus) EnumWithValue.EnumUtils.valueOf(j, NtStatus.class, STATUS_OTHER);
    }
    ...
    public boolean isInformational() {
        return (this.value >>> 30) == 1;
    }

    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public boolean isWarning() {
        return (this.value >>> 30) == 2;
    }
