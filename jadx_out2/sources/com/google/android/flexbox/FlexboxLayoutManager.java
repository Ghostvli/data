...
public class FlexboxLayoutManager extends RecyclerView.q implements p21, RecyclerView.b0.b {
    ...
    */
    public final View C2(View view, r21 r21Var) {
        boolean zA = A();
        int i = r21Var.h;
        for (int i2 = 1; i2 < i; i2++) {
            View viewJ0 = j0(i2);
            if (viewJ0 != null && viewJ0.getVisibility() != 8) {
                if (!this.x || zA) {
                    if (this.F.g(view) > this.F.g(viewJ0)) {
                        view = viewJ0;
                    }
                } else if (this.F.d(view) < this.F.d(viewJ0)) {
                }
            }
        }
        return view;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final View F2(View view, r21 r21Var) {
        boolean zA = A();
        int iK0 = (k0() - r21Var.h) - 1;
        for (int iK02 = k0() - 2; iK02 > iK0; iK02--) {
            View viewJ0 = j0(iK02);
            if (viewJ0 != null && viewJ0.getVisibility() != 8) {
                if (!this.x || zA) {
                    if (this.F.d(view) < this.F.d(viewJ0)) {
                        view = viewJ0;
                    }
                } else if (this.F.g(view) > this.F.g(viewJ0)) {
                }
            }
        }
        return view;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final int V2(r21 r21Var, d dVar) {
        float f;
        float f2;
        float f3;
        int iB;
        ...
        if (i5 == 0) {
            ...
            if (i5 != 2) {
                if (i5 == 3) {
                    f = iY;
                    f3 = (iK0 - r21Var2.e) / (r21Var2.h != 1 ? r5 - 1 : 1.0f);
                    f2 = iK0 - iP;
                } else if (i5 == 4) {
                    int i9 = r21Var2.h;
                    f3 = i9 != 0 ? (iK0 - r21Var2.e) / i9 : 0.0f;
                    float f6 = f3 / 2.0f;
                    f = iY + f6;
                    f2 = (iK0 - iP) - f6;
                } else {
                    if (i5 != 5) {
                        jr1.a("Invalid justifyContent is set: ", this.u);
                        return 0;
                    }
                    f3 = r21Var2.h != 0 ? (iK0 - r21Var2.e) / (r5 + 1) : 0.0f;
                    f = iY + f3;
                    f2 = (iK0 - iP) - f3;
                }
                float measuredWidth = f - this.E.d;
                float measuredWidth2 = f2 - this.E.d;
                ...
                while (i < i4 + iB) {
                    ...
                    if (viewQ2 == null) {
                        ...
                        int iR = aVar.r(j);
                        int iQ = this.A.q(j);
                        if (e2(viewQ2, iR, iQ, (c) viewQ2.getLayoutParams())) {
                            viewQ2.measure(iR, iQ);
                        }
                        float fA0 = measuredWidth + ((ViewGroup.MarginLayoutParams) r10).leftMargin + A0(viewQ2);
                        float fF0 = f7 - (((ViewGroup.MarginLayoutParams) r10).rightMargin + F0(viewQ2));
                        int iI0 = i3 + I0(viewQ2);
                        boolean z = this.x;
                        com.google.android.flexbox.a aVar2 = this.A;
                        if (z) {
                            aVar2.I(viewQ2, r21Var2, Math.round(fF0) - viewQ2.getMeasuredWidth(), iI0, Math.round(fF0), viewQ2.getMeasuredHeight() + iI0);
                        } else {
                            aVar2.I(viewQ2, r21Var, Math.round(fA0), iI0, viewQ2.getMeasuredWidth() + Math.round(fA0), iI0 + viewQ2.getMeasuredHeight());
                        }
                        measuredWidth = fA0 + viewQ2.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) r10).rightMargin + F0(viewQ2) + f4;
                        i6 = i10;
                        measuredWidth2 = fF0 - (((viewQ2.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) r10).leftMargin) + A0(viewQ2)) + f4);
                    }
                    i++;
                    r21Var2 = r21Var;
                    fMax = f4;
            ...
            int i11 = r21Var2.e;
            f = iY + ((iK0 - i11) / 2.0f);
            f2 = (iK0 - iP) - ((iK0 - i11) / 2.0f);
        }
        f3 = 0.0f;
        float measuredWidth3 = f - this.E.d;
        float measuredWidth22 = f2 - this.E.d;
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final int W2(r21 r21Var, d dVar) {
        float f;
        float f2;
        float f3;
        int iB;
        ...
        if (i8 == 0) {
            ...
            if (i8 != 2) {
                if (i8 == 3) {
                    f = iW;
                    f3 = (iX0 - r21Var2.e) / (r21Var2.h != 1 ? r5 - 1 : 1.0f);
                    f2 = iX0 - iB2;
                } else if (i8 == 4) {
                    int i11 = r21Var2.h;
                    f3 = i11 != 0 ? (iX0 - r21Var2.e) / i11 : 0.0f;
                    float f6 = f3 / 2.0f;
                    f = iW + f6;
                    f2 = (iX0 - iB2) - f6;
                } else {
                    ...
                    f3 = r21Var2.h != 0 ? (iX0 - r21Var2.e) / (r5 + 1) : 0.0f;
                    f = iW + f3;
                    f2 = (iX0 - iB2) - f3;
                }
                float measuredHeight = f - this.E.d;
                float measuredHeight2 = f2 - this.E.d;
                float fMax = Math.max(f3, 0.0f);
                iB = r21Var2.b();
                i = i7;
                while (i < i7 + iB) {
                    ...
                    if (viewQ2 == null) {
                        ...
                        float fI0 = measuredHeight + ((ViewGroup.MarginLayoutParams) r12).topMargin + I0(viewQ2);
                        float fI02 = f7 - (((ViewGroup.MarginLayoutParams) r12).rightMargin + i0(viewQ2));
                        if (dVar.i == 1) {
                            K(viewQ2, S);
                            E(viewQ2);
                        } else {
                        ...
                        int i12 = i9;
                        int iA0 = i5 + A0(viewQ2);
                        int iF0 = i6 - F0(viewQ2);
                        boolean z3 = this.x;
                        boolean z4 = this.y;
                        if (z3) {
                            com.google.android.flexbox.a aVar2 = this.A;
                            if (z4) {
                                z = true;
                                aVar2.J(viewQ2, r21Var2, z3, iF0 - viewQ2.getMeasuredWidth(), Math.round(fI02) - viewQ2.getMeasuredHeight(), iF0, Math.round(fI02));
                            } else {
                                z = true;
                                aVar2.J(viewQ2, r21Var, z3, iF0 - viewQ2.getMeasuredWidth(), Math.round(fI0), iF0, viewQ2.getMeasuredHeight() + Math.round(fI0));
                            }
                        } else {
                            z = true;
                            com.google.android.flexbox.a aVar3 = this.A;
                            if (z4) {
                                aVar3.J(viewQ2, r21Var, z3, iA0, Math.round(fI02) - viewQ2.getMeasuredHeight(), iA0 + viewQ2.getMeasuredWidth(), Math.round(fI02));
                            } else {
                                aVar3.J(viewQ2, r21Var, z3, iA0, Math.round(fI0), iA0 + viewQ2.getMeasuredWidth(), viewQ2.getMeasuredHeight() + Math.round(fI0));
                            }
                        }
                        measuredHeight = fI0 + viewQ2.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) r12).topMargin + i0(viewQ2) + f4;
                        i9 = i12;
                        measuredHeight2 = fI02 - (((viewQ2.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) r12).bottomMargin) + I0(viewQ2)) + f4);
                    }
                    i++;
                    r21Var2 = r21Var;
                    fMax = f4;
            ...
            int i13 = r21Var2.e;
            f = iW + ((iX0 - i13) / 2.0f);
            f2 = (iX0 - iB2) - ((iX0 - i13) / 2.0f);
        }
        f3 = 0.0f;
        float measuredHeight3 = f - this.E.d;
        float measuredHeight22 = f2 - this.E.d;
        float fMax2 = Math.max(f3, 0.0f);
        iB = r21Var2.b();
        i = i7;
        while (i < i7 + iB) {
