...
public final class MinimalEncoder {
    ...
    public static final class Result {
                ...
                if (edge2.previous == null || edge2.getPreviousStartMode() != edge2.getMode()) {
                    if (edge2.getMode() == Mode.B256) {
                        if (iPrepend <= 249) {
                            ...
                            arrayList.add(0, Byte.valueOf((byte) (iPrepend % Context.VERSION_ECMASCRIPT)));
                            arrayList.add(0, Byte.valueOf((byte) ((iPrepend / Context.VERSION_ECMASCRIPT) + 249)));
                            i = iPrepend + 2;
                        }
        ...
        public static void applyRandomPattern(List<Byte> list, int i, int i2) {
            for (int i3 = 0; i3 < i2; i3++) {
                int i4 = i + i3;
                int iByteValue = (list.get(i4).byteValue() & 255) + (((i4 + 1) * Token.JSR) % 255) + 1;
                if (iByteValue > 255) {
                    iByteValue -= 256;
                }
    ...
    public static final class Input extends MinimalECIInput {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR 
          ...
          (r2v0 java.nio.charset.Charset)
          (r3v0 int)
          (r4v0 com.google.zxing.datamatrix.encoder.SymbolShapeHint)
          (r5v0 int)
         A[MD:(java.lang.String, java.nio.charset.Charset, int, com.google.zxing.datamatrix.encoder.SymbolShapeHint, int):void (m)] (LINE:9) call: com.google.zxing.datamatrix.encoder.MinimalEncoder.Input.<init>(java.lang.String, java.nio.charset.Charset, int, com.google.zxing.datamatrix.encoder.SymbolShapeHint, int):void type: THIS */
    ...
    public static final class Edge {
        ...
        private static final int[] allCodewordCapacities = {3, 5, 8, 10, 12, 16, 18, 22, 30, 32, 36, 44, 49, 62, 86, 114, Token.LABEL, Token.DEBUGGER, 204, 280, 368, 456, 576, 696, 816, 1050, 1304, 1558};
        private static final int[] squareCodewordCapacities = {3, 5, 8, 12, 18, 22, 30, 36, 44, 62, 86, 114, Token.LABEL, Token.DEBUGGER, 204, 280, 368, 456, 576, 696, 816, 1050, 1304, 1558};
        private static final int[] rectangularCodewordCapacities = {5, 10, 16, 33, 32, 49};

        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX WARN: Removed duplicated region for block: B:27:0x0046 A[PHI: r11
        ...
        /* JADX WARN: Removed duplicated region for block: B:34:0x0056 A[PHI: r11
        ...
        */
        ...
        public static void setC40Word(byte[] bArr, int i, int i2, int i3, int i4) {
            ...
            bArr[i] = (byte) (i5 / Buffer.DEFAULT_SIZE);
            bArr[i + 1] = (byte) (i5 % Buffer.DEFAULT_SIZE);
        }
        ...
        */
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR 
          (r1v0 com.google.zxing.datamatrix.encoder.MinimalEncoder$Input)
          (r2v0 com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode)
          (r3v0 int)
          (r4v0 int)
          (r5v0 com.google.zxing.datamatrix.encoder.MinimalEncoder$Edge)
         A[MD:(com.google.zxing.datamatrix.encoder.MinimalEncoder$Input, com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode, int, int, com.google.zxing.datamatrix.encoder.MinimalEncoder$Edge):void (m)] (LINE:209) call: com.google.zxing.datamatrix.encoder.MinimalEncoder.Edge.<init>(com.google.zxing.datamatrix.encoder.MinimalEncoder$Input, com.google.zxing.datamatrix.encoder.MinimalEncoder$Mode, int, int, com.google.zxing.datamatrix.encoder.MinimalEncoder$Edge):void type: THIS */
