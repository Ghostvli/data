...
public abstract class kc {
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0010: ARITH (wrap:int:0x0004: INVOKE 
      (wrap:int:0x0000: INVOKE (r1v0 java.lang.Integer) VIRTUAL call: java.lang.Integer.intValue():int A[MD:():int (c), WRAPPED] (LINE:1))
     STATIC call: java.lang.Integer.bitCount(int):int A[MD:(int):int (c), WRAPPED] (LINE:5)) - (wrap:int:0x000c: INVOKE 
      (wrap:int:0x0008: INVOKE (r0v0 java.lang.Integer) VIRTUAL call: java.lang.Integer.intValue():int A[MD:():int (c), WRAPPED] (LINE:9))
     STATIC call: java.lang.Integer.bitCount(int):int A[MD:(int):int (c), WRAPPED] (LINE:13)) (LINE:17) */
