...
public abstract class f41 {
    ...
    */
    public static k41.b[] g(Context context, g41 g41Var, String str, CancellationSignal cancellationSignal) {
        ?? r16;
        a aVar;
        a aVar2;
        Uri uriWithAppendedId;
        boolean z;
        dq4.a("FontProvider.query");
        try {
            ArrayList arrayList = new ArrayList();
            ...
            try {
                ...
                dq4.a("ContentQueryWrapper.query");
                try {
                    try {
                        cursorB = aVarA.b(uriBuild, strArr, "query = ?", new String[]{g41Var.g()}, null, cancellationSignal);
                        if (cursorB == null || cursorB.getCount() <= 0) {
                            ...
                            while (cursorB.moveToNext()) {
                                ...
                                arrayList2.add(k41.b.a(uriWithAppendedId, i2, i3, z, i));
                                aVarA = aVar2;
                            }
                            aVar = aVarA;
                        ...
                        aVar.close();
                        return (k41.b[]) arrayList.toArray(new k41.b[0]);
                    } finally {
                    }
                } catch (Throwable th) {
                    th = th;
