...
public abstract class go0 {
    ...
    public static ColorStateList f(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !zn0.a(drawable)) {
            return null;
        }
        return bo0.a(drawable).getColorStateList();
    }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static AttributeSet i(Context context, int i, CharSequence charSequence) {
        int next;
        try {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public static void k(RippleDrawable rippleDrawable, int i) {
