...
public class s82 extends i82 implements l25.b {
    ...
    */
    public static int C2(c82 c82Var, t41 t41Var) {
        int i = t41Var.w;
        int i2 = t41Var.x;
        if (i == -1 || i2 == -1) {
            return -1;
        }
        String str = (String) gg3.q(t41Var.p);
        ...
        switch (str) {
            ...
            case "video/x-vnd.on2.vp8":
                return H2(i * i2, 2);
            case "video/hevc":
                return Math.max(2097152, H2(i * i2, 2));
            case "video/avc":
                String str2 = Build.MODEL;
                if ("BRAVIA 4K 2015".equals(str2) || ("Amazon".equals(Build.MANUFACTURER) && ("KFSOWI".equals(str2) || ("AFTS".equals(str2) && c82Var.g)))) {
                    return -1;
                }
                return H2(fy4.n(i, 16) * fy4.n(i2, 16) * Buffer.DEFAULT_SIZE, 2);
    ...
    */
    public boolean X1(DecoderInputBuffer decoderInputBuffer) {
        ...
        ByteBuffer byteBuffer;
        boolean z2 = false;
        if (M2(decoderInputBuffer)) {
            return false;
        }
        boolean zL2 = L2(decoderInputBuffer);
        m25 m25Var = this.Z0;
        if (m25Var != null) {
            long jC = m25Var.c(decoderInputBuffer.timeUs);
            z = jC != -9223372036854775807L && jC < this.Y0;
        }
        if ((!zL2 && !z) || decoderInputBuffer.hasSupplementalData()) {
            return false;
        }
        if (!decoderInputBuffer.notDependedOn()) {
            if (this.X0 != null && ((c82) gg3.q(Q0())).b.equals("video/av01") && (byteBuffer = decoderInputBuffer.data) != null) {
                boolean z3 = zL2 || this.K1 <= 0;
                ByteBuffer byteBufferAsReadOnlyBuffer = byteBuffer.asReadOnlyBuffer();
                byteBufferAsReadOnlyBuffer.flip();
                int iE = this.X0.e(byteBufferAsReadOnlyBuffer, z3);
                if (iE == 0) {
                    decoderInputBuffer.clear();
                } else if (iE != byteBufferAsReadOnlyBuffer.limit() && ((e) gg3.q(this.d1)).c + iE < byteBufferAsReadOnlyBuffer.capacity() && !decoderInputBuffer.isEncrypted()) {
                    ((ByteBuffer) gg3.q(decoderInputBuffer.data)).position(iE);
                }
            }
            if (z2) {
                if (zL2) {
                ...
                this.a1.add(Long.valueOf(decoderInputBuffer.timeUs));
                this.K1++;
            }
            return z2;
        }
    ...
    */
    public final boolean Y1() {
        ...
        if (j != -9223372036854775807L) {
            z = e1() + (j + 1) > Long.MAX_VALUE - (b1() + this.I1);
        }
        fz3 fz3Var = this.u1;
        return fz3Var == null ? super.Y1() : !fz3Var.f || this.w1 || this.D1 || (t41VarR0 != null && t41VarR0.r > 0) || z || X0() != -9223372036854775807L;
    }
