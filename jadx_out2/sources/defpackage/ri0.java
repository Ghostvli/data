...
public class ri0 extends r42 implements p.a {
    ...
    public static final class b extends h implements Comparable {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX DEBUG: Method merged with bridge method: b(Lri0$h;)Z */
        @Override // ri0.h
    ...
    public static final class i extends h {
        ...
        */
        public i(int i, br4 br4Var, int i2, e eVar, int i3, String str, int i4, boolean z) {
            boolean z2;
            boolean z3;
            int i5;
            int iM;
            ...
            super(i, br4Var, i2);
            this.k = eVar;
            int i12 = eVar.z0 ? 24 : 16;
            this.x = eVar.y0 && (i4 & i12) != 0;
            if (!z || (((i9 = (t41Var2 = this.i).w) != -1 && i9 > eVar.a) || ((i10 = t41Var2.x) != -1 && i10 > eVar.b))) {
                z2 = false;
            } else {
                float f = t41Var2.A;
                if ((f == -1.0f || f <= eVar.c) && ((i11 = t41Var2.j) == -1 || i11 <= eVar.d)) {
                    z2 = true;
                }
            }
            this.j = z2;
            if (!z || (((i6 = (t41Var = this.i).w) != -1 && i6 < eVar.e) || ((i7 = t41Var.x) != -1 && i7 < eVar.f))) {
                z3 = false;
            } else {
                float f2 = t41Var.A;
                if ((f2 == -1.0f || f2 >= eVar.g) && ((i8 = t41Var.j) == -1 || i8 >= eVar.h)) {
                    z3 = true;
                }
            }
            this.l = z3;
            ...
            while (true) {
                ...
                if (i13 >= eVar.o.size()) {
                    ...
                    iM = ri0.M(this.i, (String) eVar.o.get(i13), false);
                    if (iM > 0) {
                        break;
                    } else {
                        i13++;
            ...
            this.r = i13;
            this.s = iM;
            this.t = ri0.Q(this.i.f, eVar.p);
            int i14 = this.i.f;
            this.v = i14 == 0 || (i14 & 1) != 0;
            this.w = ri0.M(this.i, str, ri0.a0(str) == null);
            int i15 = 0;
            while (true) {
                if (i15 < eVar.m.size()) {
                    String str2 = this.i.p;
                    if (str2 != null && str2.equals(eVar.m.get(i15))) {
                        i5 = i15;
                        break;
                    }
                    i15++;
            ...
            this.q = i5;
            this.u = ri0.L(this.i, eVar.n);
            this.z = p.k(i3) == 128;
            this.A = p.s(i3) == 64;
            this.B = ri0.S(this.i.p);
            this.y = k(i3, i12);
        }
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    /* JADX DEBUG: Method merged with bridge method: c()Llr4; */
    ...
    public static final class e extends lr4 {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX DEBUG: Method merged with bridge method: M()Llr4$c; */
        @Override // defpackage.lr4
        ...
        public static final class a extends lr4.c {
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: T(I)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: U(Ljr4;)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: W([Ljava/lang/String;)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: X(Ljava/lang/String;)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: Y([Ljava/lang/String;)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: Z(I)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: a0(IZ)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: J(Ljr4;)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: K()Llr4; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: L()Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: M(I)Llr4$c; */
            @Override // lr4.c
            ...
            /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
            /* JADX DEBUG: Method merged with bridge method: R(Ljava/util/Set;)Llr4$c; */
            @Override // lr4.c
