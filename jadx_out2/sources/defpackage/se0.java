...
public final class se0 implements qg, hs4 {
    ...
    */
    public synchronized void h(aa0 aa0Var, ja0 ja0Var, boolean z) throws Throwable {
        Throwable th;
        se0 se0Var;
        se0 se0Var2;
        try {
            try {
                if (o(ja0Var, z)) {
                    ...
                    this.k = j + j2;
                    if (i > 0) {
                        this.f.c((int) Math.sqrt(j2), (j2 * 8000.0f) / i);
                        if (this.j < 2000) {
                            try {
                                if (this.k >= 524288) {
                                    this.l = (long) this.f.f(0.5f);
                                }
                                se0Var2 = this;
                                se0Var2.p(i, this.i, this.l);
                                se0Var2.h = jE;
                                se0Var2.i = 0L;
                            } catch (Throwable th2) {
                                th = th2;
