...
public class vg {
    ...
    public static final class a extends vg {
        ...
        /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR  A[MD:():void (m)] (LINE:12) call: vg.a.<init>():void type: THIS */
        public /* synthetic */ a(we0 we0Var) {
            this();
        }
    }

    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 boolean), (r2v0 boolean), (r3v0 int), (r4v0 vg$b) A[MD:(boolean, boolean, int, vg$b):void (m)] (LINE:29) call: vg.<init>(boolean, boolean, int, vg$b):void type: THIS */
