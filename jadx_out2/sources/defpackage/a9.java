...
public class a9 {
    ...
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
    public a9(ProgressBar progressBar) {
        this.a = progressBar;
    }
    ...
    public void c(AttributeSet attributeSet, int i) {
        dp4 dp4VarV = dp4.v(this.a.getContext(), attributeSet, c, i, 0);
        Drawable drawableH = dp4VarV.h(0);
        if (drawableH != null) {
            this.a.setIndeterminateDrawable(e(drawableH));
        }
        Drawable drawableH2 = dp4VarV.h(1);
        if (drawableH2 != null) {
    ...
    public final Drawable e(Drawable drawable) {
        ...
        for (int i = 0; i < numberOfFrames; i++) {
            ...
            drawableD.setLevel(FileTime.NANO100_TO_MILLI);
            animationDrawable2.addFrame(drawableD, animationDrawable.getDuration(i));
        }
        animationDrawable2.setLevel(FileTime.NANO100_TO_MILLI);
