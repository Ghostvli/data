...
public abstract class wf1 {
    ...
    public static final wf1 l = new wf1("InBody", 6) { // from class: wf1.w
        ...
        */
        public boolean k(hp4 hp4Var, vf1 vf1Var) {
            String str = hp4Var.d().e;
            ArrayList arrayListA0 = vf1Var.a0();
            if (vf1Var.X(str) != null) {
        ...
        /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:105:0x00c3 */
        /* JADX DEBUG: Failed to insert an additional move for type inference into block B:107:0x00c3 */
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public final boolean m(hp4 hp4Var, vf1 vf1Var) {
            br0 br0Var;
            br0 br0Var2;
            String str = hp4Var.d().e;
            ?? r4 = 1;
            if (vf1Var.b().G().equals(str) && !vf1Var.y0(vf1Var.b())) {
                vf1Var.r();
                return true;
            }
            boolean z2 = false;
            ...
            while (i2 < 8) {
                i2++;
                int size = vf1Var.t.size() - r4;
                while (true) {
                    br0Var = null;
                    if (size < 0 || (br0Var2 = (br0) vf1Var.t.get(size)) == null) {
                        break;
                    }
                    if (br0Var2.G().equals(str)) {
                        break;
                    }
                    size--;
                }
                ...
                if (!vf1Var.G0(br0Var2)) {
                    vf1Var.N(this);
                    vf1Var.V0(br0Var2);
                    return r4;
                }
                if (!vf1Var.d0(br0Var2.G())) {
                    vf1Var.N(this);
                    return z2;
                }
                if (vf1Var.b() != br0Var2) {
                ...
                ArrayList arrayListA0 = vf1Var.a0();
                int iLastIndexOf = arrayListA0.lastIndexOf(br0Var2);
                if (iLastIndexOf != -1) {
                    while (true) {
                        iLastIndexOf++;
                        if (iLastIndexOf >= arrayListA0.size()) {
                            break;
                        }
                        br0 br0Var3 = (br0) arrayListA0.get(iLastIndexOf);
                        if (vf1.B0(br0Var3)) {
                            br0Var = br0Var3;
                            break;
                        }
                ...
                int iP0 = vf1Var.P0(br0Var2);
                ?? r10 = z2;
                br0 br0VarL = br0Var;
                br0 br0Var4 = br0VarL;
                while (true) {
                    r10 += r4 == true ? 1 : 0;
                    br0VarL = !vf1Var.G0(br0VarL) ? br0VarL.L() : vf1Var.B(br0VarL);
                    if (br0VarL != null && !br0VarL.z("body")) {
                        if (br0VarL == br0Var2) {
                            break;
                        }
                        if (r10 > 3 && vf1Var.y0(br0VarL)) {
                            vf1Var.V0(br0VarL);
                            break;
                        }
                        if (!vf1Var.y0(br0VarL)) {
                            vf1Var.W0(br0VarL);
                        } else {
                            if (!vf1Var.G0(br0VarL)) {
                                vf1Var.N(this);
                                vf1Var.V0(br0VarL);
                                break;
                            }
                            String strC = br0VarL.C();
                            String strG = br0VarL.G();
                            String strF = vf1Var.f();
                            ?? r16 = r4 == true ? 1 : 0;
                            br0 br0Var5 = new br0(vf1Var.z(strC, strG, strF, g83.d), vf1Var.U());
                            vf1Var.Y0(br0VarL, br0Var5);
                            vf1Var.a1(br0VarL, br0Var5);
                            if (br0Var4 == br0Var) {
                                iP0 = vf1Var.P0(br0Var5) + 1;
                            }
                            br0Var5.d0(br0Var4);
                            br0VarL = br0Var5;
                            br0Var4 = br0VarL;
                ...
                ?? r162 = r4 == true ? 1 : 0;
                B2.d0(br0Var4);
                br0 br0Var6 = new br0(br0Var2.U0(), vf1Var.U());
                br0Var6.f().d(br0Var2.f());
                Iterator it = br0Var.m().iterator();
                while (it.hasNext()) {
                    br0Var6.d0((l33) it.next());
                }
                br0Var.d0(br0Var6);
                vf1Var.V0(br0Var2);
                vf1Var.T0(br0Var6, iP0);
                vf1Var.W0(br0Var2);
                vf1Var.u0(br0Var, br0Var6);
                r4 = r162;
                z2 = false;
            }
            return r4;
        ...
        /*
            Code decompiled incorrectly, please refer to instructions dump.
        */
        public final boolean n(hp4 hp4Var, vf1 vf1Var) {
            byte b2;
            byte b3;
            ?? r3;
            hp4.h hVarE = hp4Var.e();
            ...
            switch (strI.hashCode()) {
                case -1644953643:
                    b2 = !strI.equals("frameset") ? (byte) -1 : (byte) 0;
                    break;
                case -1377687758:
                    if (strI.equals("button")) {
                        b2 = 1;
                        break;
                    }
                    break;
                case -1191214428:
                    if (strI.equals("iframe")) {
                        b2 = 2;
                        break;
                    }
                    break;
                case -1134665583:
                    if (strI.equals("keygen")) {
                        b3 = 3;
                        b2 = b3;
                    }
                    break;
                case -1010136971:
                    if (strI.equals("option")) {
                        b3 = 4;
                        b2 = b3;
                    }
                    break;
                case -1003243718:
                    if (strI.equals("textarea")) {
                        b3 = 5;
                        b2 = b3;
                    }
                    break;
                case -906021636:
                    ...
                    break;
                case -891985998:
                    if (strI.equals("strike")) {
                        b3 = 7;
                        b2 = b3;
                    }
                    break;
                case -891980137:
                    if (strI.equals("strong")) {
                        b3 = 8;
                        b2 = b3;
                    }
                    break;
                case -80773204:
                    if (strI.equals("optgroup")) {
                        b3 = 9;
                        b2 = b3;
                    }
                    break;
                ...
                case Token.ASSIGN_LSH /* 105 */:
                    ...
                    break;
                case Token.HOOK /* 115 */:
                    if (strI.equals(SardineUtil.CUSTOM_NAMESPACE_PREFIX)) {
                        b3 = 13;
                        b2 = b3;
                    }
                    break;
                ...
                case 110115790:
                    ...
                    break;
                case 181975684:
                    if (strI.equals("listing")) {
                        b3 = 52;
                        b2 = b3;
                    }
                    break;
                case 1973234167:
                    if (strI.equals("plaintext")) {
                        b3 = 53;
                        b2 = b3;
                    }
                    break;
                case 2115613112:
                    if (strI.equals("noembed")) {
                        b3 = 54;
                        b2 = b3;
                    }
                    break;
            ...
            switch (b2) {
                case 0:
                    vf1Var.N(this);
                    ArrayList arrayListA0 = vf1Var.a0();
                    if (arrayListA0.size() < 2) {
                        return false;
                    }
                    if (arrayListA0.size() > 2) {
                        r3 = 1;
                        if (!((br0) arrayListA0.get(1)).z("body")) {
                            return false;
                        }
                    } else {
                        r3 = 1;
                    ...
                    br0 br0Var = (br0) arrayListA0.get(r3);
                    if (br0Var.L() != null) {
                        br0Var.Q();
                    }
                    while (arrayListA0.size() > r3) {
                        arrayListA0.remove(arrayListA0.size() - r3);
                    }
                    vf1Var.o0(hVarE);
                    vf1Var.j1(wf1.y);
                    return r3;
                ...
                case 6:
                    ...
                    vf1Var.O(false);
                    if (!hVarE.f) {
                        wf1 wf1VarH1 = vf1Var.h1();
                        if (wf1VarH1.equals(wf1.n) || wf1VarH1.equals(wf1.p) || wf1VarH1.equals(wf1.r) || wf1VarH1.equals(wf1.s) || wf1VarH1.equals(wf1.t)) {
                            vf1Var.j1(wf1.v);
                        } else {
                            vf1Var.j1(wf1.u);
                        }
                ...
                case 50:
                    vf1Var.U0();
                    vf1Var.R0(vf1Var.o0(hVarE));
                    return true;
                case 10:
                    if (vf1Var.T("a") != null) {
                        vf1Var.N(this);
                        vf1Var.t("a");
                        br0 br0VarX = vf1Var.X("a");
                        if (br0VarX != null) {
                            vf1Var.V0(br0VarX);
                            vf1Var.W0(br0VarX);
                        }
                ...
                case 17:
                    vf1Var.O(false);
                    ArrayList arrayListA02 = vf1Var.a0();
                    int size = arrayListA02.size();
                    int i2 = size - 1;
                    int i3 = i2 >= 24 ? size - 25 : 0;
                    while (true) {
                        if (i2 >= i3) {
                            br0 br0Var2 = (br0) arrayListA02.get(i2);
                            if (fg4.g(br0Var2.G(), z.k)) {
                                vf1Var.t(br0Var2.G());
                            } else if (!vf1.B0(br0Var2) || fg4.g(br0Var2.G(), z.j)) {
                                i2--;
                            }
                        }
                    }
                ...
                case 26:
                    vf1Var.O(false);
                    ArrayList arrayListA03 = vf1Var.a0();
                    int size2 = arrayListA03.size() - 1;
                    while (true) {
                        if (size2 > 0) {
                            br0 br0Var3 = (br0) arrayListA03.get(size2);
                            if (br0Var3.z("li")) {
                                vf1Var.t("li");
                            } else if (!vf1.B0(br0Var3) || fg4.g(br0Var3.G(), z.j)) {
                                size2--;
                            }
                        }
                    }
                ...
                case 35:
                    vf1Var.U0();
                    vf1Var.q0(hVarE, "http://www.w3.org/2000/svg");
                    return true;
                ...
                case Token.GETELEM /* 39 */:
                    vf1Var.N(this);
                    ArrayList arrayListA04 = vf1Var.a0();
                    if (arrayListA04.size() < 2) {
                        return false;
                    }
                    if ((arrayListA04.size() > 2 && !((br0) arrayListA04.get(1)).z("body")) || vf1Var.H0("template")) {
                        return false;
                    }
                    vf1Var.O(false);
                    br0 br0VarX2 = vf1Var.X("body");
                    if (br0VarX2 != null) {
                        wf1.i(hVarE, br0VarX2);
                    }
                    return true;
                ...
                case Token.CALL /* 43 */:
                    ...
                    if (vf1Var.a0().size() > 0) {
                        wf1.i(hVarE, (br0) vf1Var.a0().get(0));
                    }
                    return true;
                case Token.NAME /* 44 */:
                    vf1Var.U0();
                    vf1Var.q0(hVarE, "http://www.w3.org/1998/Math/MathML");
                    return true;
                ...
                case Token.STRING /* 46 */:
                    ...
                    return true;
                case 48:
                    if (vf1Var.X("svg") == null) {
                        return vf1Var.s(hVarE.F("img"));
                    }
                    vf1Var.o0(hVarE);
                    return true;
                case Token.FALSE /* 49 */:
                    vf1Var.U0();
                    if (!vf1Var.p0(hVarE).e("type").equalsIgnoreCase("hidden")) {
                        vf1Var.O(false);
                    }
                    return true;
                case Token.SHEQ /* 51 */:
                    if (vf1Var.V().i1() != wm0.b.quirks && vf1Var.b0("p")) {
                        vf1Var.t("p");
                    }
                    vf1Var.o0(hVarE);
                    vf1Var.O(false);
                ...
                case Token.BINDNAME /* 54 */:
                    ...
                    return true;
                default:
                    al4 al4VarY = vf1Var.y(hVarE);
                    op4 op4VarN = al4VarY.n();
                    if (op4VarN != null) {
                        wf1.b(hVarE, vf1Var, op4VarN);
                    } else if (!al4VarY.g()) {
                        vf1Var.o0(hVarE);
                    } else if (fg4.g(strI, z.h)) {
                        if (vf1Var.b0("p")) {
                            vf1Var.t("p");
                        }
                        vf1Var.o0(hVarE);
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0000: CONSTRUCTOR (r1v0 java.lang.String), (r2v0 int) A[MD:(java.lang.String, int):void (m)] (LINE:5) call: wf1.<init>(java.lang.String, int):void type: THIS */
