...
public final class pu2 implements hz0 {
    ...
    /* JADX DEBUG: Can't inline method, not implemented redirect type for insn: 0x0006: FILLED_NEW_ARRAY (wrap:pu2:0x0002: CONSTRUCTOR  A[MD:():void (m), WRAPPED] (LINE:3) call: pu2.<init>():void type: CONSTRUCTOR) (LINE:7) elemType: hz0 */
    /* JADX DEBUG: Don't trust debug lines info. Lines numbers was adjusted: min line is 1 */
