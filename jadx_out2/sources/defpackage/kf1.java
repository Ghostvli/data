...
public final class kf1 implements xy1.b, xy1.f, i14, mz0, ex3.d {
    ...
    */
    public boolean o0(jy0[] jy0VarArr, boolean[] zArr, gx3[] gx3VarArr, boolean[] zArr2, long j, boolean z) {
        boolean z2;
        z();
        int i = this.J;
        int i2 = 0;
        for (int i3 = 0; i3 < jy0VarArr.length; i3++) {
            ff1 ff1Var = (ff1) gx3VarArr[i3];
            if (ff1Var != null && (jy0VarArr[i3] == null || !zArr[i3])) {
                this.J--;
                ff1Var.d();
                gx3VarArr[i3] = null;
            }
        }
        boolean z3 = z || (!this.X ? j == this.U : i != 0);
        jy0 jy0VarO = this.i.o();
        boolean z4 = z3;
        jy0 jy0Var = jy0VarO;
        for (int i4 = 0; i4 < jy0VarArr.length; i4++) {
            jy0 jy0Var2 = jy0VarArr[i4];
            if (jy0Var2 != null) {
                int iD = this.N.d(jy0Var2.c());
                if (iD == this.Q) {
                    this.i.A(jy0Var2);
                    jy0Var = jy0Var2;
                }
                if (gx3VarArr[i4] == null) {
                    this.J++;
                    ff1 ff1Var2 = new ff1(this, iD);
                    gx3VarArr[i4] = ff1Var2;
                    zArr2[i4] = true;
                    if (this.P != null) {
                        ff1Var2.b();
                        int i5 = this.P[iD];
                        if (!z4 && i5 >= 0) {
                            d dVar = this.A[i5];
                            z4 = (dVar.G() == 0 || dVar.d0(j, true)) ? false : true;
                        }
                    }
                }
            }
        ...
        if (this.J == 0) {
        ...
        } else if (this.s.isEmpty() || Objects.equals(jy0Var, jy0VarO)) {
            z2 = z;
            if (z4) {
                n0(j, z2);
            ...
            if (!this.X) {
                ...
                se1 se1VarM = M();
                jy0 jy0Var3 = jy0Var;
                jy0Var3.b(j, j2, -9223372036854775807L, this.t, this.i.c(se1VarM, j));
                if (jy0Var3.k() != this.i.n().d(se1VarM.d)) {
                }
                if (z4) {
                }
            }
