...
public final class z4 implements i35 {
    ...
    public z4(RelativeLayout relativeLayout, ShapeableImageView shapeableImageView, MaterialTextView materialTextView, MaterialTextView materialTextView2, MaterialTextView materialTextView3, MaterialTextView materialTextView4) {
                ...
                if (materialTextView2 != null) {
                    ...
                    if (materialTextView3 != null) {
                        ...
                        if (materialTextView4 != null) {
                            return new z4((RelativeLayout) view, shapeableImageView, materialTextView, materialTextView2, materialTextView3, materialTextView4);
                        }
                    }
                }
            }
    ...
    public static z4 c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(fm3.K, viewGroup, false);
        if (z) {
